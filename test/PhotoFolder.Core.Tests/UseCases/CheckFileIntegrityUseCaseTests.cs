...
//            mockPhotoDirectory.Setup(x => x.GetFileDirectoryTemplate(file)).Returns(directoryRegex);
//            mockPhotoDirectory.Setup(x => x.GetFilenameTemplate(file)).Returns(filenameRegex);
