...
namespace PhotoFolder.Application.Shared
{
    /// <summary>
    ...
    public class PropertyChangedBase : INotifyPropertyChanged
    {
        ...
        protected virtual bool SetProperty<T>(ref T field, T value, Expression<Func<object>> property) =>
            SetProperty(ref field, value, GetPropertyName(property));
